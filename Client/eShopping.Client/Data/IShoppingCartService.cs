...
namespace eShopping.Client.Data
{
    public interface IShoppingCartService 
    {
        ...
        Task<(bool, HttpStatusCode?, Exception?, T?)> GetShoppingCartByIdAsync<T>(int shoppingCartId, string queryString, CancellationToken? cancellationToken = null) where T : ShoppingCart;
        Task<(bool, HttpStatusCode?, Exception?, bool)> DeleteShoppingCartByIdAsync<T>(int shoppingCartId, CancellationToken? cancellationToken = null) where T : ShoppingCart;
        ...
        Task<(bool, HttpStatusCode?, Exception?, long?)> GetShoppingCartItemsCountAsync<T>(int shoppingCartId, CancellationToken? cancellationToken = null) where T : ShoppingCartItem;
        ...
        Task<(bool, HttpStatusCode?, Exception?, bool)> DeleteShoppingCartItemByIdAsync<T>(int shoppingCartItemId, CancellationToken? cancellationToken = null) where T : ShoppingCartItem;
